...
<tr>
    <td class="label">
        <div style="position: relative;">
            <span><%= RelationshipMetadata.Name %></span>
    ...
    <td class="control">
        ...
        <script type="text/javascript">
            ...
            function addAttachment() {
                ...
                attachment.Title = "New attachment";
        ...
        <input type="hidden" id="attachmentsJson" name="<%= RelationshipMetadata.Name %>" value="<%= Server.HtmlEncode(Value) %>" />
